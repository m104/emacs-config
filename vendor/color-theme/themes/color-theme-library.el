...
(defun color-theme-glow ()
  "Color theme by Adam Collins, created 2009-01-06."
  (interactive)
  (color-theme-install
   '(color-theme-glow
     ...
     (cursor ((t (:background "#777777"))))
     ;(dired-face-directory ((t (:bold t :foreground "dark blue" :weight bold))))
     ;(dired-face-executable ((t (:foreground "green yellow"))))
     ;(dired-face-flagged ((t (:foreground "tomato"))))
     ;(dired-face-marked ((t (:foreground "light salmon"))))
     ;(dired-face-permissions ((t (:foreground "aquamarine"))))
     ...
     (font-lock-function-name-face ((t (:bold t :foreground "#a3ebff" :weight bold))))
     (font-lock-keyword-face ((t (:bold t :foreground "#2bf1dc" :weight bold))))
     (font-lock-reference-face ((t (:foreground "#AEAEAE"))))
     ...
     (info-header-xref ((t (:bold t :weight bold :foreground "dark blue"))))
     (info-menu-5 ((t (:underline t))))
     (info-menu-header ((t (:bold t :weight bold))))
     (info-node ((t (:bold t :weight bold))))
     (info-xref ((t (:bold t :foreground "dark blue" :weight bold))))
     (isearch ((t (:foreground "#ffffff" :background "#0060c0"))))
     (isearch-lazy-highlight-face ((t (:foreground "#bbbbbb" :background "#0060c0"))))
